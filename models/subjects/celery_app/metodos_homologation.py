from . import base_external_dbsource_task as db
import pandas as pd

dbsource = db.BaseExternalDbsource()

class Validator:
    def __init__(self,database_banner):
        self.database = 'dara_mallas'
        self.database_banner = database_banner
    ...
    def get_homologations_for_subject_period_area_banner(self,subject_code="",period="",area=""):
        ...
        res = dbsource.query(sql=sql,option=self.database_banner)
        return res if res else False
